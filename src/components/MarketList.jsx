  ...
  return (
    <div className="flex md:flex-row flex-col items-start w-[97%] mx-[1.5%] gap-4 md:gap-[1.5%] my-5 ">
      <div className=" shadow-lg p-4 w-full md:w-1/2 rounded-md bg-amber-400">
        <div className=" text-2xl font-bold font-playwrite text-center mb-4">
          ...
          {result &&
            result.map((data, index) => (
              <div
                ...
                className=" font-poppins text-center font-semibold text-blue-900 cursor-pointer hover:text-blue-950 hover:animate-pulse transition-all duration-300 ease-in-out text-base sm:text-lg"
              >
