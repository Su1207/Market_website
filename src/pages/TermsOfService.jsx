...
const TermsOfService = () => {
  ...
  return (
    <div>
      <div className=" w-full p-6 bg-orange-300 font-poppins">
        ...
        <p className="text-justify sm:text-left mb-4 text-sm">
          ...
          rules set forth in the applicable App Distributors terms of service;
        ...
        <p className="text-justify sm:text-left mb-4 text-sm">
          ...
          Site is hosted in Canada. If you access the Site from any other region
        ...
        <div className="mb-4">
          ...
          <p className="text-justify sm:text-left mb-2">
            ...
            determined by the language of the contract. The governing law of the
            contract shall be the substantive law of the jurisdiction agreed
            upon by the parties.
          </p>
        </div>
        ...
        <p className="text-justify sm:text-left mb-4 text-sm">
          ...
          ACCURACY OR COMPLETENESS OF THE SITES CONTENT OR THE CONTENT OF ANY
          ...
          NOT WARRANT, ENDORSE, GUARANTEE WE DO NOT WARRANT, ENDORSE, GUARANTEE,
