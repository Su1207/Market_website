...
const PrivacyNotice = () => {
  ...
  return (
    <div className=" px-4 p-6 bg-orange-300 font-poppins">
      ...
      <p className="text-justify sm:text-left text-sm mb-4">
        ...
        which include the Website and App), we appreciate that you are trusting
      ...
      <ul className="text-sm list-disc ml-6 mb-4">
        ...
        <li className="mb-1">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</li>
        <li className="mb-1">6. HOW LONG DO WE KEEP YOUR INFORMATION?</li>
        <li className="mb-1">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</li>
        <li className="mb-1">8. DO WE COLLECT INFORMATION FROM MINORS?</li>
        <li className="mb-1">9. WHAT ARE YOUR PRIVACY RIGHTS?</li>
        <li className="mb-1">10. CONTROLS FOR DO-NOT-TRACK FEATURES</li>
        <li className="mb-1">
          11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
        </li>
        <li className="mb-1">12. DO WE MAKE UPDATES TO THIS NOTICE?</li>
        <li className="mb-1">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</li>
        <li className="mb-1">
      ...
      <ul className="text-sm list-disc ml-6 mb-4">
        <li className="mb-1">
          ...
          email addresses; mailing addresses; usernames; passwords; contact
          preferences; contact or authentication data; debit/credit card
        ...
        <li className="mb-1">
          ...
          payment instrument. All payment data is stored by __________. You may
      ...
      <ul className="text-sm list-disc ml-6 mb-4">
        <li className="mb-1">
          <strong>Geo-Location Information.</strong> We may request access or
          permission to and track location-based information from your mobile
          device, either continuously or while you are using our App, to provide
          certain location-based services. If you wish to change our access or
        ...
        <li className="mb-1">
          ...
          If you are using our App, we may also collect information about the
      ...
      <ul className="text-sm list-disc ml-6 mb-4">
        ...
        <li className="mb-1">
          ...
          testimonial, please contact us at __________ and be sure to include
        ...
        <li className="mb-1">
          ...
          Services, subscribing to marketing or otherwise contacting us, we will
      ...
      <ul className="text-sm list-disc ml-6 mb-4">
        ...
        <li className="mb-1">
          ...
          advertising companies to serve ads when you visit the Services. These
      ...
      <p className="text-justify sm:text-left text-sm mb-4">
        ...
        <a
          href="https://app.termly.io/notify/7fa87dc9-69ff-4d12-9a2f-5ab1043b9269"
          className="text-blue-500 underline"
        >
          here
        </a>
