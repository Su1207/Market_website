    ...
    <div className=" w-full font-poppins bg-orange-100 min-h-screen ">
      ...
      <div className="mb-4 mx-4 bg-[#45ffc7] shadow-lg rounded-md p-4 py-8 text-center">
        ...
        <p className=" text-xs sm:text-sm text-gray-700">
          ...
          Matka Result, and more. Moreover, gambling or Satta is illegal in
          India since the British government introduced the Public Gambling Act
          in 1867.
        </p>
      </div>
      ...
      <div className="mb-4 mx-4 bg-[#45ffc7] shadow-lg rounded-md p-4 py-8 md:flex items-center gap-5">
        ...
        <p className=" flex-1 text-xs sm:text-sm md:text-left text-center text-gray-700">
          ...
          more.
          <br />
          <br /> In the last few years, online games has gained popularity in
          the country. Today in the digital world, satta games is played mostly
          online through several websites. The game has it’s origin before
          Indian Independence. Not only this, there are many Apps on Playstore
          that one can use to play the game. Those who prefer to play offline
          game can do so by visiting the shop near them to place the bet and
          check results.
          <br />
          <br />
          Although gambling is illegal in India since the British government
          introduced the Public Gambling Act in 1867, online Satta Matka is
          legal. Many people participate in it to try their luck. Some lotteries
          and horse racing games are also legal in India. Played between more
          than one people, the game involves guessing numbers to win the prize,
          including Rs 1 crore.
        </p>
      </div>
      ...
      <div className="mb-4 mx-4 bg-[#45ffc7] shadow-lg rounded-md p-4 py-8 text-center">
        ...
        <p className=" text-xs sm:text-sm text-gray-700">
          ...
          Sun Gum and Full Sun Gum Satta Matka Online.
          <br />
          <br /> Kalyan Jodi Chart and Kalyan Panel Chart is available on the
          site so that users can analyze the old Satta results before playing.
        </p>
      </div>
      ...
      <div className="mb-4 mx-4 bg-[#45ffc7] shadow-lg rounded-md p-4 py-8 text-center">
        ...
        <div>
          ...
          <p className=" text-xs sm:text-sm text-gray-700">
            ...
            <br /> Kalyan Night Result: 9:45 PM- 11:45
            <br />
            <br /> PM Kalyan jodi chart shows the number of pairs as the name
            suggest “Jodi”. This helps users to guess the right number in Kalyan
            Game. One must be go through these Kalyan Jodi Chart in order to Win
            More in Kalyan Jodi. Participants ahouls also keep track of Kalyan
            Panel Chart before participating in a game. This will help them
            understand the game better and take the right decision. Go to
          </p>
        </div>
      </div>
